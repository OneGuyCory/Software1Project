...
namespace Cory_Deuschle_Software1
{
    class Inventory
    {
        ...
        public static Product LookupProduct(int productID)
        {
            ...
            Product emptyProd = new Cory_Deuschle_Software1.Product();
            return emptyProd;
        }
        ...
        public static void UpdateInHousePart(int partID, InHousePart inPart)
        {
            ...
            {
                if (Parts[i].GetType() == typeof(Cory_Deuschle_Software1.InHousePart))
                {
        ...
        public static void UpdateOutsourcedPart(int partID, OutsourcedPart outPart)
        {
            for (int i = 0; i < Parts.Count; i++)
            {
                if (Parts[i].GetType() == typeof(Cory_Deuschle_Software1.OutsourcedPart))
                {
